...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function nl(){return new rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:io(),fragmentShader:`
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function il(){return new rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:io(),fragmentShader:`
